...
const UserForm = ({ closeModal, fetchData, isUpdateMode, userId }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-8 rounded-lg w-96">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {isUpdateMode?<button type="submit" className="bg-blue-600 text-white px-4 py-2 rounded-md w-full">Update User</button> :<button type="submit" className="bg-blue-600 text-white px-4 py-2 rounded-md w-full">Create User</button>}
        </form>
      </div>
    </div>
  );
